...
## Running the App
The app can be launched by running `shiny::runGitHub("READ-PSB-LWT-DFO_NARW_trigger", username = "NEFSC", ref = "master")` in your RStudio environment. Click 'Run App' to get started. In the window that pops up, click "Open in Browser".
